...
public class controler {
    ...
    public void getData(){
        personlist = DB.getPersones(conn);
        familiyList = DB.getFamilys(conn);
        genderList = DB.getGender(conn);
        statusList = DB.getStatus(conn);
        placeList = DB.getPlace(conn);
    }

    public void showPersones(){
        view.showPersones(personlist, familiyList, genderList, statusList, placeList);
    }
